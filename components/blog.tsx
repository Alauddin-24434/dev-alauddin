        ...
        <section id="blog" className="py-16 md:py-24 bg-muted/30">
            <div className="container mx-auto px-4">
                ...
                <Tabs defaultValue="view-blogs" className="w-full">
                    <TabsList className="grid w-full grid-cols-2 mb-8 max-w-sm mx-auto" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <TabsContent value="view-blogs">
                        ...
                        <div className="text-center mt-16" data-aos="fade-up" data-aos-delay="200"> {/* Added data-aos and delay */}
