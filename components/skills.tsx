...
// Mapping skill names to Lucide icons for a more "official" look
const skillIcons: { [key: string]: React.ElementType } = {
  ...
  Zustand: Fish,
  Sass: Droplet,
  "Node.js": Leaf, // Node.js logo is a leaf
  "Express.js": Rocket,
  Python: Terminal, // Generic code icon for languages without specific Lucide icons
  Django: Shield,
  PHP: Terminal, // Generic code icon
  "REST APIs": Link,
  GraphQL: GitGraph,
  NestJS: Bird,
  MongoDB: Database, // Using generic database icon for now
  PostgreSQL: Database, // Using generic database icon for now
  MySQL: Database, // Using generic database icon for now
  Firebase: Flame,
  Supabase: Bolt,
  Redis: Redo,
  Prisma: Database, // Using generic database icon for now
  Git: GitBranch,
  Docker: Docker,
  AWS: Cloud,
  Vercel: Triangle, // Using Next.js icon as Vercel is closely related
  Netlify: Cloud, // Generic cloud icon
  ...
  Asana: Kanban,
  "VS Code": Settings,
  ESLint: Bug, // Linting often finds bugs
  Prettier: Brush,
  Webpack: Package,
  Vite: Bolt,
...
export function Skills() {
  const skillCategories = [
    ...
    },
    {
      ...
      skills: ["Node.js", "Express.js", "Python", "Django", "PHP", "REST APIs", "GraphQL", "NestJS"],
    },
    {
      title: "Database & Storage",
      icon: Database,
      description: "Managing and optimizing data storage solutions.",
      skills: ["MongoDB", "PostgreSQL", "MySQL", "Firebase", "Supabase", "Redis", "Prisma"],
    },
    {
      title: "DevOps & Cloud",
      icon: Cloud,
      description: "Automating deployment, scaling, and infrastructure management.",
      skills: ["Git", "Docker", "AWS", "Vercel", "Netlify", "GitHub Actions", "CI/CD"],
    },
    {
      title: "Design & UI/UX",
      icon: Palette,
      description: "Crafting intuitive and visually appealing user experiences.",
      skills: ["Figma", "Adobe XD", "Photoshop", "Responsive Design", "User Experience", "Prototyping"],
    },
    // "Mobile Development" category removed as per request
    {
      title: "Testing & Quality Assurance",
      icon: ShieldCheck,
      description: "Ensuring code reliability and application stability.",
      skills: ["Jest", "Cypress", "React Testing Library", "Unit Testing", "Integration Testing"],
    },
    {
      title: "Project Management & Tools",
      icon: LayoutDashboard,
      description: "Organizing workflows and collaborating effectively.",
      skills: ["Jira", "Trello", "Asana", "VS Code", "ESLint", "Prettier", "Webpack", "Vite"],
    },
    {
  ...
  return (
    <section id="skills" className="py-20 bg-gradient-to-br from-gray-50 to-white dark:from-gray-950 dark:to-black">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16 animate-fade-in-up">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            A comprehensive overview of the technologies, tools, and principles I master to build exceptional digital
            products.
          </p>
        </div>
